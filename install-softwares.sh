...
echo -e "$password\n" | sudo -S dnf update -y
echo -e "$password\n" | sudo -S dnf install fedora-workstation-repositories
echo -e "$password\n" | sudo -S dnf config-manager --set-enabled google-chrome
echo -e "$password\n" | sudo -S dnf install google-chrome-stable
...
echo -e "$password\n" | sudo -S dnf install https://dev.mysql.com/get/mysql80-community-release-fc30-1.noarch.rpm
echo -e "$password\n" | sudo -S dnf install mysql-community-server
...
echo "Installing VLC"
echo -e "$password\n" | sudo -S dnf install https://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-$(rpm -E %fedora).noarch.rpm
echo -e "$password\n" | sudo -S dnf install https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm
echo -e "$password\n" | sudo -S dnf install vlc
